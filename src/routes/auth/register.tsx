    ...
    if (type == "github") {
      ...
      await authClient.signIn.social(
        ...
        },
        {
          ...
          onSuccess: () => {
            toast.success("Registration successful, redirecting to /welcome.");
          },
        }
      );
    } else if (type == "google") {
      ...
      toast.warning("Sign-up type not supported.");
    }
  };
    ...
    <div className="flex h-screen max-w-screen items-center justify-center overflow-hidden">
      <div className="h-full w-full md:w-1/2 flex flex-col space-y-6 item-center justify-center">
        <div className="flex flex-col justify-center items-center px-2">
          ...
          <p className="text-2xl font-medium mt-8">Hey there, welcome!</p>
